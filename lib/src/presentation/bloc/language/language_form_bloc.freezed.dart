...
class __$$_SelectLanguageCopyWithImpl<$Res>
    extends _$LanguageFormEventCopyWithImpl<$Res, _$_SelectLanguage>
...
class _$_SelectLanguage implements _SelectLanguage {
  const _$_SelectLanguage(this.locale);
...
abstract class _SelectLanguage implements LanguageFormEvent {
  const factory _SelectLanguage(final Locale locale) = _$_SelectLanguage;
...
/// @nodoc
abstract class _$$_LanguageFormStateCopyWith<$Res>
    implements $LanguageFormStateCopyWith<$Res> {
  factory _$$_LanguageFormStateCopyWith(_$_LanguageFormState value,
          $Res Function(_$_LanguageFormState) then) =
      __$$_LanguageFormStateCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {RequestState state,
...
/// @nodoc
class __$$_LanguageFormStateCopyWithImpl<$Res>
    extends _$LanguageFormStateCopyWithImpl<$Res, _$_LanguageFormState>
    implements _$$_LanguageFormStateCopyWith<$Res> {
  __$$_LanguageFormStateCopyWithImpl(
      _$_LanguageFormState _value, $Res Function(_$_LanguageFormState) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_LanguageFormState(
      state: null == state
          ? _value.state
          : state // ignore: cast_nullable_to_non_nullable
              as RequestState,
...
class _$_LanguageFormState implements _LanguageFormState {
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_LanguageFormStateCopyWith<_$_LanguageFormState> get copyWith =>
      __$$_LanguageFormStateCopyWithImpl<_$_LanguageFormState>(
          this, _$identity);
}
...
abstract class _LanguageFormState implements LanguageFormState {
  const factory _LanguageFormState(
      ...
      required final List<Locale> supportedLocales}) = _$_LanguageFormState;
